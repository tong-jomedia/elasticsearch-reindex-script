...
checkReindexFinshed "$ES_PEOPLE_INDEX" "book_author"
checkReindexFinshed "$ES_PEOPLE_INDEX" "book_artist"
checkReindexFinshed "$ES_PEOPLE_INDEX" "movie_actor"
checkReindexFinshed "$ES_PEOPLE_INDEX" "movie_writer"
checkReindexFinshed "$ES_PEOPLE_INDEX" "movie_producer"
checkReindexFinshed "$ES_PEOPLE_INDEX" "movie_director"
checkReindexFinshed "$ES_PEOPLE_INDEX" "game_developer"
