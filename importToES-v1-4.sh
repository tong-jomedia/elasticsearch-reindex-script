...
#importMedia "MusicAlbumArtist" "music_artist" "$ES_PEOPLE_INDEX" "seq_id" "music_album_artist"
#importMedia "MusicSongArtist" "music_artist" "$ES_PEOPLE_INDEX" "seq_id" "music_song_artist"
...
importMedia "MusicSong" "music" "$ES_MUSIC_SONG_INDEX" "seq_id" "" 100000
